...
class loginPage(unittest.TestCase):
    ...
    def test_negative_login_invalid_password(self, error_message):
        login_page = LoginPage(self.driver)
        login_page.login("sona.ghukasyan@gmail.com", "123456")

        expected_error_message = "password is incorrect"

        self.assertTrue(expected_error_message.lower() in error_message,
                        f"Expected error message '{expected_error_message.lower()}' not found in '{error_message}'")
